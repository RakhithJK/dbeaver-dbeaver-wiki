...
-vars|Path to a property file with variables|`-vars c:\path\to\file.properties`<br>For more information see [the main article](#supplying-variables-from-the-outside-world)

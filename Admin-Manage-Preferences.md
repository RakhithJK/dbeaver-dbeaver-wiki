...
---------------------------------------|---------|-----------------|--------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------
 ...
 navigator.object.defaultEditorPage    | string  | Last opened     | `default.object.editor`, `org.jkiss.dbeaver.ui.editors.data.DatabaseDataEditor`, `org.jkiss.dbeaver.erd.ui.editor.ERDEditorEmbedded` | Setting for the behavior of default editor page.               

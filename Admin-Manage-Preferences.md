...
---------------------------------------|---------|-----------------|--------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------
 ...
 navigator.connection.doubleClick      | string  | Expand          | `EDIT`, `CONNECT`, `SQL_EDITOR`, `SQL_EDITOR_NEW`,                                                                                   | Setting for the behavior on double-clicking on connection.     
 navigator.object.defaultEditorPage    | string  | Last opened     | `default.object.editor`,<br>`org.jkiss.dbeaver.ui.editors.data.DatabaseDataEditor`,<br>`org.jkiss.dbeaver.erd.ui.editor.ERDEditorEmbedded` | Setting for the behavior of default editor page.               
